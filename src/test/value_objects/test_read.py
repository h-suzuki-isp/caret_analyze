import os
from caret_analyze import Architecture, Lttng, Application,Plot

def test_accept():
    # trace_data = os.path.expanduser('~/.ros/tracing/session-20240417161654')
    trace_data = os.path.expanduser('~/CARET_ws/architecture_reader/e2e_sample_intersub')
    ...
    # arch.export('arch.yaml', force=True)
    ...
    # arch_from_yaml = Architecture('yaml', 'new_arch_autware_data.yaml')
